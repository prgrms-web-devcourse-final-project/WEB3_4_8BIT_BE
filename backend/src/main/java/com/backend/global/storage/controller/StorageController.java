...
public class StorageController {
	...
	public ResponseEntity<GenericResponse<List<FileUploadResponse>>> getPresignedUrls(
		@RequestBody @Valid final FileUploadRequest.Request request
	) {
		List<FileUploadResponse> response = storageService.generateUploadUrls(request.domain(), request.fileList());
